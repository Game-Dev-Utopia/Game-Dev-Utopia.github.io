      ...
      <div className='flex flex-wrap justify-center mb-10 py-1 bg-slate-900'>
        {
          menu.map((val, i) => (
            <div
              key={i}
              className={`text-white p-1 my-2 px-3 mx-1 cursor-pointer shadow-sm hover:bg-gradient-to-r from-cyan-500 to-blue-500  bg-slate-800 shadow-gray-600 rounded-full `}>
              <DropdownMenu>
                <DropdownMenuTrigger className="flex justify-center outline-none font-medium text-sm gap-1.0 items-center ">
                  {val.title}
                  <TiArrowSortedDown className="ml-2 transform scale-150 " />
                </DropdownMenuTrigger>
        ...
        <div className={`${select.Downloadable ?
          "ml-1 my-2 text-center h-12 px-5 rounded-full items-center inline-flex text-sm font-medium bg-gradient-to-r from-cyan-500 to-blue-500 text-white"
          :
          "ml-1 my-2 text-center h-12 px-5 rounded-full items-center inline-flex text-sm font-medium shadow-sm hover:bg-cyan-500 to-blue-500 bg-slate-800 shadow-gray-600"}`}
          onClick={() => {
        ...
        <div
          className={`${filterCount > 0 ? "visible" : "invisible"} mx-2 my-2 p-1 px-3 flex items-center font-medium text-sm gap-2 cursor-pointer shadow-sm hover:bg-gradient-to-r from-cyan-500 to-blue-500 bg-slate-800  shadow-gray-600 rounded-full`}
          onClick={() => {
            clearFilters();
