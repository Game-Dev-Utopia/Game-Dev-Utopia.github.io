...
const Timeline = ({ datas }) => {
  ...
  return (
    <>
      ...
      Explore the evolution of gaming magic with Gamedevutopia History Timeline. Journey through the milestones, from pixelated pioneers to immersive virtual worlds, tracing the artistry, technology, and culture that shaped gaming as we know it. Whether you're a seasoned gamer or a curious newcomer, uncover the stories behind your favorite titles and the visionaries who brought them to life.
      </p>
      <div
        ref={ScrollRef}
