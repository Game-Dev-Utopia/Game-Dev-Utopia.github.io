...
const MemberCard = ({ data }) => {
    ...
    return (
        <div className="w-1/4 relative mt-16  mb-16 sm:mb-24">
            <div className="rounded overflow-y-scroll shadow-md bg-gradient-to-br from-slate-900 via-slate-700 to-slate-600">
                ...
                <div className="px-6 mt-16">
                    ...
                    <p className="whitespace-pre-wrap overflow-y-scroll text-gray-200 text-base pt-3 font-normal h-32">
                        {data.intro}
                    </p>
