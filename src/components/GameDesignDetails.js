...
export default function GameDesignDetails({ isGame }) {
  return (
    <section className="w-full bg-gray-100 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border border-gray-100">
      <div className="grid grid-cols-2 ">
        <div className="border-gray-300 border-2 m-2 p-2 rounded-md">
